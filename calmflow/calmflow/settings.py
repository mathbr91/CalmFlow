"""
Django settings for calmflow project.
CalmFlow - App de Suporte Emocional & Manejo de Bem-Estar
"""
...
SECRET_KEY = config(
    'SECRET_KEY',
    default='django-insecure-dev-key-change-in-production-environment-calmflow'
)
...
# Internationalization - Configurações para Português (Brasil)
LANGUAGE_CODE = 'pt-br'
